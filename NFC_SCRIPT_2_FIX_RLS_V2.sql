-- ============================================================
-- NFC SCRIPT #2 — Corregir RLS (VERSIÓN ALTERNATIVA)
-- Ejecutar en: Supabase > SQL Editor (SEGUNDO)
-- Si el Script #2 original da error, usa ESTE
-- ============================================================

-- PASO 1: Eliminar políticas existentes (ejecuta cada línea por separado si da error)
-- Copia y pega cada una de estas líneas en el SQL Editor y ejecuta:
...
-- PASO 2: Una vez eliminadas, ejecuta el resto de este script:
