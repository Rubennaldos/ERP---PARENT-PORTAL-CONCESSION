...
-- Lima Analytics Design System - VERSIÓN SEGURA
-- =====================================================

-- LIMPIAR TABLAS E ÍNDICES EXISTENTES (si los hay)
DROP TABLE IF EXISTS parent_activity_log CASCADE;
...
DROP POLICY IF EXISTS "Los padres pueden ver su propia actividad" ON parent_activity_log;
DROP POLICY IF EXISTS "Los admins pueden ver toda la actividad" ON parent_activity_log;
DROP POLICY IF EXISTS "Sistema puede insertar actividad" ON parent_activity_log;
DROP POLICY IF EXISTS "Los padres pueden ver sus propias sesiones" ON parent_sessions;
DROP POLICY IF EXISTS "Los admins pueden ver todas las sesiones" ON parent_sessions;
...
-- ✅ LISTO: Sistema de tracking completo instalado
-- Ahora puedes usar el dashboard de Analytics de Padres
