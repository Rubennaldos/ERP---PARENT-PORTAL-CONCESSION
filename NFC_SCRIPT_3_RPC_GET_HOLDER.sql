-- ============================================================
-- NFC SCRIPT #3 — Crear funcion RPC get_nfc_holder
-- Ejecutar en: Supabase > SQL Editor (TERCERO)
-- FIX: usar FLOAT8 no NUMERIC para evitar type mismatch
-- ============================================================
